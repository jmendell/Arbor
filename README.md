...
* If theme name is changed, make sure your publicPath is changed to the correct theme.
* Run 'yarn start' to get Browsersync up and running and get to building!
