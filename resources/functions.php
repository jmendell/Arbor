...
function dump_this($dumpee) {
echo "<pre>";
var_dump($dumpee);
echo "</pre>";
}

// Creates ability to add custom class to wp_nav_menu list items
...
if( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_sub_page(array(
        'page_title' 	=> 'Get Started Settings',
...
if ( ! function_exists( 'arbor_gutenberg_support' ) ) :
    function arbor_gutenberg_support() {
    ...
    add_action( 'after_setup_theme', 'arbor_gutenberg_support' );
endif;